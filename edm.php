...
<body>
    ...
    <div class="single-hero-slide d-flex align-items-center justify-content-center">
        ...
        <div class="hero-slides-content text-center">
            <h2 data-animation="fadeInUp" data-delay="100ms">EDM<span>EDM</span></h2>
                        ...
                        <div class="album-songs h-100">
                            <div class="album-all-songs">
                                <div class="music-playlist">
                                    ...
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Animals - Martin Garrix</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/207-martin_garrix_-_animals - Copy.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Summer - Calvin Harris</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Calvin Harris - Summer.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Turn down for what - DJ Snake</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/DJ_Snake-Turn_Down_For_What_feat_Lil_Jon_.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Ten Feet Tall - Afrojack</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Afrojack - Ten Feet Tall ft. Wrabel.mp3">
                                        </audio>
                                    </div>
                                </div>
                            </div>
