...
<body>
    ...
    <div class="single-hero-slide d-flex align-items-center justify-content-center">
        ...
        <div class="hero-slides-content text-center">
            <h2 data-animation="fadeInUp" data-delay="100ms">Punjabi<span>Punjabi</span></h2>
                        ...
                        <div class="album-songs h-100">
                            <div class="album-all-songs">
                                <div class="music-playlist">
                                    ...
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Jee Karr daa - Harrdy Sandhu</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Jee Karr Daa - Harrdy Sandhu.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Proper Patola - Diljit Dosanjh</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Proper-Patola-Diljit-Dosanjh,Badshah.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
