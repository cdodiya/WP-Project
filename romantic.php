...
<head>
    ...
    <title>BANGER - Bollywood Romantic</title>
...
<body>
    ...
    <div class="single-hero-slide d-flex align-items-center justify-content-center">
        ...
        <div class="hero-slides-content text-center">
            <h2 data-animation="fadeInUp" data-delay="100ms">Romantic<span>Romantic</span></h2>
                            ...
                            <div class="album-all-songs">
                                <div class="music-playlist">
                                    <div class="single-music active">
                                        <h6>Tujhe Dekha toh yeh - DDLJ</h6>
                                    ...
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Beete Lamhein - The Train</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Beete-Lamhein-K.K.,Kshiti-Tarey.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Kaho na Kaho - Murder</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Kaho-Na-Kaho-Amir-Jamal.mp3">
                                        </audio>
                                    </div>
                                    <br><br><br>
                                    <div class="single-music active">
                                        <h6>Aa jao meri - Ajab Prem ki Ghazab Kahani</h6>
                                        <audio preload="auto" controls>
                                            <source src="audio/Aa Jao Meri Tamanna (Ajab Prem Ki Ghazab Kahani )(DJMazacom.Com).mp3">
                                        </audio>
                                    </div>
                                </div>
                            </div>
